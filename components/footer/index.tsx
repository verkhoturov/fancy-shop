    ...
    <footer className="footer">
        ...
        <div className="section footer__contacts">
            <div className="footer__note">
                <p>
                    La titularidad del presente sitio web corresponde a HeadstashBCN / Guillermo
                    Quan con CIF Y5163902W y domicilio social Carrer de Francesc Pujols, 7, Local 1,
                    08002 Barcelona, España.
                    <br />
                    <br />
                    Las semillas de marihuana se venden con fines decorativos y para coleccionismo.
                    HeadStashBCN no se hace responsable del uso o cultivo de estas semillas.
                </p>
            </div>
            ...
            <div className="footer__address">
                ...
                <br />
                <p>
                    Phone: <a href="tel:+38224545235">+382 245 452 35</a>
                </p>
                <address>
                    Adress: Carrer de Francesc Pujols, 7, Local 1, 08002 Barcelona, España.
                </address>
            </div>
        </div>
    </footer>
