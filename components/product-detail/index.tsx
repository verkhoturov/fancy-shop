            ...
            <div className="product-detail__item product-detail__item--desc">
                <div className="product-detail__desc">
                    <p className="product-detail__desc-text">
                        The Blue Jelly [(Blue Sherb x (Gelato 41 x Sherb bx1)] pheno we used as the
                        female in this hybrid was bred and selected in-house from regular seeds. The
                        plant we kept out of 50 was then hit with reversed Z Road pollen to create
                        Blue Fizz. Blue Jelly turned out to be one of the more stand-out crosses to
                        come from the gelato 41 x sherb bx1 line, but never got released as she only
                        produced a handful of seeds. This plant definitely has some special
                        attributes as the offspring she’s produced with the Z Road has also proven
                        to be a favourite from the entire line among our team.
                    </p>
                    <p className="product-detail__desc-text">
                        The infamous bluish hues and sweet sugary terps from her grandma (Blue
                        Sherb) seem to be super recessive traits so far throughout the three times
                        we have done breeding projects with her. Consequently, this cross provides a
                        pool of plants with a high proportion of colourful Z/Sherb type variations;
                        making it hard to narrow down the keepers. If you are familiar with the
                        heavyweight lineage of this delicious pairing then you know what to expect
                        from these. The OG heritage leaking into these Z Road hybrids is also
                        helping maintain a steady level of potency providing some full package box
                        tickers within this line
                    </p>
                </div>
